...
* [GitHub Issues](https://github.com/wiselike/revel/issues)
...
```
$ go get github.com/wiselike/revel                        # Install Revel
$ cd $GOPATH/src/github.com/wiselike/revel                # Change directory to revel repo
...
```
$ go test github.com/wiselike/revel
```

Refer to the
[Travis configuration](https://github.com/wiselike/revel/blob/master/.travis.yml)
...
[issues](https://github.com/wiselike/revel/issues?labels=contributor+ready&page=1&state=open).
